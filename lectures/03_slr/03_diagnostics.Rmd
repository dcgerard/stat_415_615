...
- Interpretation: Cars that are 50\% heavier tend to have $-17.0 \times \log(1.5) = -6.9$ worse miles per gallon.
...
- Countries that drink twice as much wine per capita tend to have ($2^{-0.3556} = 0.78$) 22\% fewer deaths per 1000 individuals.
...
- Prediction interval:
    ...
    - So countries that drink 20 liters per person per year tend to have mortality rates of about $\exp(1.49) = 4.4$ deaths per 1000 individuals. With a prediction interval of $\exp(0.984) = 2.7$ to $\exp(1.997) = 7.4$ deaths per 1000 individuals.
