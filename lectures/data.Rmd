...
- [baldur.csv](./data/baldur.csv): Data scraped from the [Baldur's Gate Fandom Wiki](https://baldursgate.fandom.com/wiki/Companions). This contains the ability scores, alignments, races, and classes for the playable companions in the [Baldur's Gate](https://en.wikipedia.org/wiki/Baldur%27s_Gate) I and II video games. Variables include:
