...
- [soap.csv](./data/soap.csv): Researchers were studying the relationship between line speed and the amount of scrap for the data for two production lines in a soap production company. The variables include
