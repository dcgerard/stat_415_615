...
- [tax.csv](./data/tax.csv): These data were extracted from the scatterplot of Figure 1 of @cesaretti2020. Economists think moderng cities are more efficient engines of economic growth, producing more output per individual. This is because of various factors like easier access to skilled labor, logistical cost savings because folks are closer together, etc. @cesaretti2020 wanted to test if this was also true in old England. They collected data from the 1524--1525 tax years from 93 towns. Variables include:
