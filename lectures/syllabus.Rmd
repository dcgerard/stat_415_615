...
- **Office**: DMTI 106E
- **Office Hours**: Tuesdays and Wednesdays, 4:00 PM to 5:00 PM
...
- **Required**: Free PDF version of [Applied Linear Statistical Models (Fifth Edition)](http://users.stat.ufl.edu/~winner/sta4211/ALSM_5Ed_Kutner.pdf) by Kutner, Nachtsheim, Neter, and Li. They also released a book called "Applied Linear Regression Models (Fourth Edition)" which is just a subset of this book. I will generally abbreviate this book as KNNL.
...
- Final Exam: 20%
  - In class, closed notes, closed book.
  - Focuses on the second half of material, but indirectly cumulative.
- Final Project: 25%
  - Project Proposal: 5%
  - Status update: 5%
  - Final Report: 5%
...
3. Simple Linear Regression (Chapters 1-5 of KNNL).
    a. The model and interpretation.
    b. Inference (estimation/hypothesis testing).
    c. Diagnostics and remedial measures.
4. Multiple Linear Regression (Chapters 6-8 of KNNL).
    a. The model and interpretation.
    b. Inference (estimation/hypothesis testing).
    c. Diagnostics and remedial measures.
5. Model Building (Chapters 9-11 of KNNL).
    a. Theoretical considerations.
    b. The limited usability of automated procedures.
6. Experimental Design.
    a. Simulation as a general tool.
...
- 10/12/2021--10/13/2021: Tentative dates for midterm exam.
- 11/23/2021: Tuesday classes cancelled; Friday classes meet.
- 11/24/2021: Wednesday classes cancelled; Thanksgiving holiday.
- 12/14/2021: Final exam for Tuesday section at 5:30 PM.
- 12/15/2021: Final exam for Wednesday section at 5:30 PM.
