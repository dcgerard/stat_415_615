...
- **Required**: Required: [Applied Linear Regression Models (4th Edition)](https://wrlc-amu.primo.exlibrisgroup.com/permalink/01WRLC_AMU/1g8hf8s/alma99146673233604102) **OR** [Applied Linear Statistical Models (Fifth Edition)](https://wrlc-amu.primo.exlibrisgroup.com/permalink/01WRLC_AMU/1g8hf8s/alma9978254993604102)
  - Do **not** get both. One is a sub-book of the other.
  - In the lecture notes, I abbeviate this book as "KNNL"
...
- **Optional**: [The Statistical Sleuth](https://wrlc-amu.primo.exlibrisgroup.com/permalink/01WRLC_AMU/1g8hf8s/alma99132367533604102). This is the best non-mathematical treatment of basic Statistical analysis that exists. I use some of their datasets, and reference this book for best practices. If you do not remember basic statistical concepts, this is the best book you can get to review those concepts.

- I will also provide you with supplemental PDF readings as required.

# Computing and Software

We will use the R computing language to complete assignments. R is free and may be downloaded from the R website (<http://cran.r-project.org/>). In addition, I highly recommend you interface with R through the free RStudio IDE (<https://www.rstudio.com/>). R and RStudio are also available on computers in the Anderson Computing Complex in addition to [various labs across campus](https://www.american.edu/oit/campus-computing-facilities.cfm). R Studio may also be run from your web browser using American University's [Virtual Applications System](https://americanuniversity.service-now.com/help/?id=sc_cat_item&sys_id=1fdf972fdbb3db00771cfce9af961985). Please see me during office hours if you have questions regarding R.

# Assignments and Grading

- Weekly homeworks: 25%
  - These will be self-graded.
- Participation: 15%
  - Show up to class
  - Answer questions in class
  - Work on in-class exercises
  - Stay off your phones, stay off social media, etc
- First Midterm: 20%
...
- If you are taking this class for graduate credit, I'll have you learn and apply a novel statistical method in your final project. These are topics more advanced than what we cover in this class. Possible topics include:
...
- *Tuesday, 10/13/2026: Midterm 1
- Friday, 10/16/2026: No class (Fall break).
- Friday, 11/06/2026: Last day to withdraw or change a grade option
- Tuesday, 11/24/2026: Class meets via Zoom (Thanksgiving)
- Friday, 11/27/2026: No class (Thanksgiving)
- *Friday, 12/11/2026: Midterm 2
- Friday, 12/18/2026: Final project presentations (02:30PM-05:00PM)

- *These dates are VERY tentative and subject to change.
...
![](./syllabus_capstone_banner.png){fig-alt="Capstone learning outcomes."}\ 


1. Application: Build on prior knowledge, skills, or dispositions in a new context. 

2. Synthesis: Identify and execute a significant project that addresses a substantive disciplinary or professional concern.  

3. Reflection: Articulate the knowledge, skills, or dispositions gained during the student’s undergraduate education or used in the project.  
...
- You cannot use an extension for elements of the final project or for exams.
