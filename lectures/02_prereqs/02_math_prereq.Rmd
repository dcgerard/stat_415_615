...
- Often, we consider linear relationships on the log-scale.

- $\exp(x) = e^x = \underbrace{e \times \dots \times e}_{x\, \textrm{times}}$.

- The last equality only follows if $x$ is positive integer, but exponentiation can be extended to any real number.
