...
- $A$ has 150 percent the value of $B$.
    ...
    - In general, $A$ has $\fra{A}{B}\times 100\%$ the value of $B$.
...
- **Exercise**: Suppose John makes \$40,000 a year and Alina makes \$50,000 a year. Provide four different ways to describe the multiplicative difference between John's and Alina's salaries.
