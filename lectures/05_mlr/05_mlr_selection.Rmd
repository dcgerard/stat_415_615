...
- Here, we talk about **model selection**.
...
- If your dataset is large, then you can split your data into a training and a test set. You can do whatever variable selection techniques you want on your training set, then fit your final model on your test set to obtain $p$-values that have the proper interpretation.
