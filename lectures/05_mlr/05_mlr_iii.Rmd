...
- Of course, we would want to interpret these on the original scale.
    ...
    - Cars that have 1 liter higher engine displacement tend to have $e^{\beta_3}$ times higher mpg on average, adjusting for car type.
...
- So we could tell a client something like:
    1. In general, higher weight tends to decrease fuel-mileage.
