...
- We can write out the coefficients of multiple determination using this notation as well.
\begin{align}
R^2_{Y1} &= \frac{SSR(X_1)}{SSTO}\\
R^2_{Y12} &= \frac{SSR(X_1, X_2)}{SSTO}\\
R^2_{Y123} &= \frac{SSR(X_1, X_2, X_3)}{SSTO}\\
&\text{etc...}
\end{align} 
...
- **Exercise**: Consider the following ANOVA table with Type I Sums of Squares:
    ...
    anova(lmout)
    ```
    Remember that $X_1$ is triceps, $X_2$ is thigh, and $X_3$ is midarm.
