...
4. For each row of the above ANOVA table, state the full and reduced models of the hypothesis tests.
...
5. For each row of the above ANOVA table, state the conclusions of the hyptohesis tests.
...
6. Conduct an overall $F$-test for the model. 
    $$
...
8. Is it possible to run an $F$-test lack-of-fit for the model
    $$
    Y_i = \beta_0 + \beta_1X_{i1} + \beta_2 X_{i2} + \epsilon_i?
    $$
