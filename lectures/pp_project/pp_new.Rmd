...
<!-- - @han2022using -->
<!--     - No need to do the neural network. -->
<!--     - Data are in a PDF file. Try [`{pdftables}`](https://cran.r-project.org/web/packages/pdftables/index.html). -->
<!-- - @luedeker2022relationship -->
...
- If your numbers are not the same as in the paper, you should switch projects. This takes up time.
