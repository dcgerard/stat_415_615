...
- For the normal linear model, you further assume that $\mathbf{\epsilon}$ is distributed according to the [multivariate normal distribution](https://en.wikipedia.org/wiki/Multivariate_normal_distribution).
